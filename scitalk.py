...
level = st.selectbox("학년을 선택하세요", ["중학교 1학년", "중학교 2학년", "중학교 3학년", "고등학교"])
if level == "고등학교":
...
# 1-1. 학생 관심 분야 선택
st.header("1️⃣-1 관심 있는 분야 선택")
interest_area = st.selectbox("관심 분야를 선택하세요", ["음악", "미술", "체육", "기술", "의학", "자연과 환경", "인문사회", "기타"])
